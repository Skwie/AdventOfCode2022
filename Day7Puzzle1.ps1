...
foreach ($line in $fixedInput) {
    ...
    if ($line -match '\d{2,}') {
        [int]$currentData += $line.Split(" ")[0]
            ...
            if ((($currentPath.Split("/")).Count -1) -gt 2) {
                ...
                if ((($prevPath.Split("/")).Count -1) -gt 2) {
                    ...
                    if ((($prevPrevPath.Split("/")).Count -1) -gt 2) {
                        ...
                        if ((($prevPrevPrevPath.Split("/")).Count -1) -gt 2) {
                            ...
                            if ((($prev4Path.Split("/")).Count -1) -gt 2) {
                                ...
                                if ((($prev5Path.Split("/")).Count -1) -gt 2) {
...
foreach ($dataValue in $dataTable.Values) {
    if ($dataValue -le 100000) {
        [int]$answer += $dataValue
    }
}